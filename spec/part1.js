  ...
  describe('Part I', function() {
    ...
    describe('uniq', function() {
      ...
      it('should handle iterators that work with a sorted array', function() {
        ...
        //The iterator returns true only when the value is 1, else it returns false;
        //So calling iterator on this array will yield [true,false,false,false,false,false];
